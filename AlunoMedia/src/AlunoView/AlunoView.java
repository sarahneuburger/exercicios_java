...
public class AlunoView extends JFrame {
	...
	public AlunoView() {
		...
		primeiraNota.setHorizontalAlignment(SwingConstants.CENTER);
		...
		segundaNota.setHorizontalAlignment(SwingConstants.CENTER);
		...
		terceiraNota.setHorizontalAlignment(SwingConstants.CENTER);
		...
		quartaNota.setHorizontalAlignment(SwingConstants.CENTER);
		...
		situacao.setFont(new Font("Tahoma", Font.PLAIN, 14));
